...
const Courses = ({ setCurrentPage }) => {
  ...
  // Handle enrollment navigation - Navigate to enroll page with courseId
  const handleEnrollment = (courseId) => {
    ...
    // Navigate to enroll page with courseId
    console.log('Navigating to enroll page with course ID:', courseId);
    setCurrentPage('enroll', { courseId });
  };
  ...
  const handleViewDetails = (courseId) => {
    console.log('Navigating to course detail with ID:', courseId);
              ...
              <div className="course-footer">
                ...
                <div className="course-actions">
                  <button 
                    ...
                    onClick={() => handleViewDetails(course.id || course._id)}
                  >
                    View Details
                  </button>
                  <button 
                    className="course-btn primary"
                    onClick={() => handleEnrollment(course.id || course._id)}
                  >
                    Enroll Now
                  </button>
                </div>
