...
import { Home, BookOpen, Users, User, Settings, LogOut, Menu, X, GraduationCap, Award, Star, UserCheck, BookMarked, UserPlus, ClipboardList, FileText } from 'lucide-react';
import './Navbar.css';
...
const Navbar = ({ 
  ...
  const handleNavigation = (page) => {
    ...
    if (['home', 'courses', 'dashboard', 'instructor-dashboard'].includes(page)) {
  ...
  const getNavigationItems = () => {
    ...
    if (userRole === 'student') {
      authenticatedItems.push(
        ...
        { key: 'test', label: 'Test', icon: FileText }, //ed Test for students
        { key: 'reviews', label: 'Reviews', icon: Star } // Changed from 'score' to 'reviews'
      );
      ...
      authenticatedItems.push(
        ...
        { key: 'instructor-quizzes', label: 'Quizzes', icon: ClipboardList }, // New quiz tab
