    ...
    try {
      ...
      const formattedData = {
        ...
        categoryDistribution: (dashboardData.data?.categoryDistribution || []).map(cat => ({
          ...
          value: Math.round((cat.count / (dashboardData.data?.overview?.totalCourses || 1)) * 100) || 0,
          courses: cat.count || 0,
          revenue: (cat.totalEnrollments || 0) * 50 // Approximate revenue
        })),
        ...
        enrollmentTrends: (enrollmentsData.data?.stats?.trends || []).map(trend => ({
          ...
          enrollments: trend.count || 0,
          completions: Math.round((trend.count || 0) * 0.6),
          dropouts: Math.round((trend.count || 0) * 0.1)
        })),
        revenueData: (enrollmentsData.data?.stats?.trends || []).map(trend => ({
          ...
          enrollments: trend.count || 0,
          refunds: Math.round((trend.revenue || 0) * 0.05)
        })),
        platformMetrics: {
                ...
                <div className="insights-list">
                  ...
                  <div className="insight-item">
                    ...
                    <div>
                      ...
                      <p className="insight-text">{formatCurrency(67000)} earned this month</p>
                    </div>
                  </div>
                  <div className="insight-item">
                    ...
                    <div>
                      ...
                      <p className="insight-text">4.3 average course rating maintained</p>
                    </div>
                  </div>
                  <div className="insight-item">
