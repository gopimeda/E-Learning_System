...
import { Home, BookOpen, Users, User, Settings, LogOut, Menu, X, GraduationCap, Award, Star, UserCheck, BookMarked } from 'lucide-react';
import './Navbar.css';
  ...
  const getNavigationItems = () => {
    ...
    if (userRole === 'student') {
      authenticatedItems.push(
        ...
        { key: 'score', label: 'Scores', icon: Award }
      );
